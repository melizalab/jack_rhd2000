...
public:
        ...
        double const & upper_bandwidth() const;
        double set_upper_bandwidth(double);

        double const & lower_bandwidth() const;
        double set_lower_bandwidth(double);

        bool & dsp_enabled();
        bool const & dsp_enabled() const;
        double const & dsp_cutoff() const;
        double set_dsp_cutoff(double);

        void set_amp_power(short channel, bool powered);
